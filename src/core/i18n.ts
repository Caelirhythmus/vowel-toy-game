...
export const zh = {
  ...
  'btn.close': '关闭',
  'btn.speak': '发音',
  'btn.speak.note': 'Piper 神经合成 · 首次使用需加载语音模型（约 28MB，缓存后免下载）',
  'btn.speak.loading': '语音模型加载中…',
  'btn.speak.loading.pct': '语音模型加载中… {pct}%',
  'btn.speak.loading.note': '语音模型后台加载中（CDN，约 18MB，仅首次）；现在点击将先用近似朗读，加载完成后自动升级',
...
export const en: Record<I18nKey, string> = {
  ...
  'btn.close': 'Close',
  'btn.speak': 'Speak',
  'btn.speak.note': 'Piper neural synthesis · first use downloads the voice model (~28MB, cached after)',
  'btn.speak.loading': 'Loading voice model…',
  'btn.speak.loading.pct': 'Loading voice model… {pct}%',
  'btn.speak.loading.note': 'Voice model loading in background (CDN, ~18MB, first time only); clicking now uses approximate speech, auto-upgrades when ready',
